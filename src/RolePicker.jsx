...
// ⚠ 4.9 — פיילוט: כשיש רשימת PILOT_COACHES (src/flags.js) המסך הזה לא מוצג
// בכלל — «הרשמה» נוחתת ישר על הרשמת מאמן (App.jsx, PLAYER_SIGNUP), והדלת
// «שחקן» נפתחת רק מקישור #/join של מאמן. הקובץ לא השתנה — רק עוקפים אותו.

/* CourtSide — סרטון תדמית 9:16, ~46 שניות.
   ...
   ⚠ הטקסטים כאן נכתבו מחדש (25.8.2026) לעברית מדוברת. שלושה כללים:
   1. גוף שני יחיד — «אתה», לא «כותבים». מאמן מדבר עם מאמן, לא מדריך הפעלה.
   2. בלי רשימות עם נקודתיים. «דקה: נוכחות, עומס, MVP» הוא ניסוח של מצגת;
      «מי היה, כמה זה היה קשה לו, ומה לזכור» הוא משפט שמישהו אומר בקול.
   3. בלי הבטחות שאי אפשר לעמוד בהן — «ספרייה שגדלה כל שבוע» היא טענה שאי
      אפשר לאמת, ו«על הפרקט» סותר את ההחלטה שהאפליקציה לא בשימוש תוך כדי אימון. */
...
const SCREENS = [
  { id: 'Home', src: 'assets/screen-home.png', ih: 4200, p0: 0, p1: -880, word: 'הכל במקום אחד.', sub: 'נכנסת, ורואה מה יש היום.' },
  { id: 'Plan', src: 'assets/screen-notebook.png', ih: 2814, p0: -60, p1: -740, word: 'בונה את האימון.', sub: 'דף אחד, כמו מחברת — בכתב יד או בהקלדה.' },
  { id: 'Drills', src: 'assets/screen-drills.png', ih: 2348, p0: 0, p1: -420, word: 'צריך תרגיל?', sub: 'יש ספרייה שלמה בעברית, ואתה מוסיף משלך.' },
  { id: 'Tactics', src: 'assets/screen-tactics.png', ih: 2352, p0: -90, p1: -470, word: 'מצייר את המהלך.', sub: 'כמו על הלוח, רק שזה נשאר לך.' },
  { id: 'Review', src: 'assets/screen-review.png', ih: 2520, p0: -40, p1: -540, word: 'ואחרי האימון — דקה.', sub: 'מי היה, כמה זה היה קשה לו, ומה לזכור.' },
  { id: 'Player', src: 'assets/screen-player.png', ih: 1956, p0: 0, p1: -180, word: 'לכל שחקן יש כרטיס.', sub: 'כל מה שרשמת עליו השנה — ורק אתה רואה.' },
  { id: 'Season', src: 'assets/screen-schedule.png', ih: 2694, p0: -40, p1: -620, word: 'והלו״ז מסתדר לבד.', sub: 'ימי אימון קבועים נכנסים אליו שבוע אחרי שבוע.' },
  { id: 'Community', src: 'assets/screen-community.png', ih: 3404, p0: -40, p1: -1000, word: 'ואתה לא לבד בזה.', sub: 'מאמנים אחרים משתפים תרגילים ומערכים. קח מה שמתאים לך.' },
];

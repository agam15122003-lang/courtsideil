...
| ענף פרודקשן | `main` — עומד על `7d76d5e` (30.7). **כל עבודת 30.7 באוויר** (18 קומיטים: מסכי הדלת 1a–1j, ראש המסך, 16a, 3a, 13a, 14a, 5a, 10a, 3b, 12a, 18a). שני קבצי ה-SQL שלמטה עדיין מחכים להרצה. |
